            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    <DropdownMenuItem asChild>
                        <Link href={`/mehsullar/${productSlug}`} className="flex items-center gap-2 cursor-pointer">
                            <Eye className="h-4 w-4" />
                            Bax
                        </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                        <Link href={`${ROUTES.admin.products}/${productId}`} className="flex items-center gap-2 cursor-pointer">
            ...
            <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Bu əməliyyat geri qaytarıla bilməz. Məhsul və ona aid şəkillər tamamilə silinəcək.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
